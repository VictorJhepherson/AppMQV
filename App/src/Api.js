...
export default {
    ...
    updateUser: async (USR_ID, USR_NAME, USR_DATEBIRTHDAY, USR_PHONENUMBER, USR_STATUS, USR_INSTAGRAM, USR_FACEBOOK, USRTYPE, CHURCH_ID, USRDOC_CPFNUMBER, USRDOC_RGNUMBER, SU_LOGINNAME, STREET, NEIGHBORHOOD, NUMBER_HOUSE, COMPLEMENT, CITY, STATE, TYPEHOUSE, P_USRID_REGUSER) => {
        const token = await AsyncStorage.getItem('token');
        const req = await fetch(`${BASE_API}/users`, {
            method: 'PATCH',
            headers: {
            ...
            body: JSON.stringify({USR_ID, USR_NAME, USR_DATEBIRTHDAY, USR_PHONENUMBER, USR_STATUS, USR_INSTAGRAM, USR_FACEBOOK, USRTYPE, CHURCH_ID, USRDOC_CPFNUMBER, USRDOC_RGNUMBER, SU_LOGINNAME, STREET, NEIGHBORHOOD, NUMBER_HOUSE, COMPLEMENT, CITY, STATE, TYPEHOUSE, P_USRID_REGUSER})
        });
        const json = await req.json();
        return json;
    },
